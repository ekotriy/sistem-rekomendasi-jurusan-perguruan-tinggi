...
$resultcek = mysqli_query($conn, "SELECT * FROM keterampilan WHERE id_user = '{$_SESSION['id_user']}' ");
...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO keterampilan (id_user,bahasa,logika,sains,praktek,sosial) VALUES ('$id_user','$bahasa','$logika','$sains','$praktek','$sosial')";
