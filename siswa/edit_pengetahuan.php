...
$tampil = mysqli_query($conn, "SELECT * FROM pengetahuan WHERE id_user = '{$_SESSION['id_user']}' ");
...
if (isset($_POST["submit"])) {
    ...
    $sql = "UPDATE pengetahuan SET bahasa='$bahasa',logika='$logika',sains='$sains',praktek='$praktek',sosial='$sosial' WHERE id_user='$id_user'";
