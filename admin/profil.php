                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="card-profile__info">
                            ...
                            <li><strong class="text-dark mr-4">Status</strong> <span><?= $data['jurusan'] ?></span></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="form-validation">
                            <form class="form-valide" action="#" method="post">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-jurusan">Status</label>
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" id="val-jurusan" name="jurusan" value="<?= $data['jurusan'] ?>" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
